...
export default function QualityPage() {
  const { data: firestoreQuality, loading: firestoreQualityLoading, add: addToQualityIndicator, update: updateQualityIndicatorDoc, remove: removeQualityIndicatorDoc } = useFirestoreCollection(
    COLLECTIONS.QUALITY_INDICATORS,
    [],
    []
  )
