...
export default function AbsencePage() {
  const { data: firestoreAbsence, loading: firestoreAbsenceLoading, add: addToAttendanceRecord, update: updateAttendanceRecordDoc, remove: removeAttendanceRecordDoc } = useFirestoreCollection(
