...
export default function LeaveAbsencePage() {
  const { data: firestoreLeave, loading: firestoreLeaveLoading, add: addToLeaveRequest, update: updateLeaveRequestDoc, remove: removeLeaveRequestDoc } = useFirestoreCollection(
