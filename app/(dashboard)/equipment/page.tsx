...
export default function EquipmentPage() {
  const { data: firestoreEquipment, loading: firestoreEquipmentLoading, add: addToEquipment, update: updateEquipmentDoc, remove: removeEquipmentDoc } = useFirestoreCollection(
