...
export default function TrainingPage() {
  const { data: firestoreTraining, loading: firestoreTrainingLoading, add: addToTraining, update: updateTrainingDoc, remove: removeTrainingDoc } = useFirestoreCollection(
