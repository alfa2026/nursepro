...
export default function BedManagementPage() {
  const { data: firestoreDepts, loading: firestoreDeptsLoading, add: addToDepartment, update: updateDepartmentDoc, remove: removeDepartmentDoc } = useFirestoreCollection(
