...
export default function DepartmentsPage() {
  const { data: firestoreDepartments, loading: firestoreDepartmentsLoading, add: addToDepartment, update: updateDepartmentDoc, remove: removeDepartmentDoc } = useFirestoreCollection(
