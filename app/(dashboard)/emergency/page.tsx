...
export default function EmergencyCodesPage() {
  const { data: firestoreEmergency, loading: firestoreEmergencyLoading, add: addToEmergencyCode, update: updateEmergencyCodeDoc, remove: removeEmergencyCodeDoc } = useFirestoreCollection(
    COLLECTIONS.EMERGENCY_CODES,
    [],
    []
  )
