...
export default function AttendancePage() {
  const { data: firestoreAttendance, loading: firestoreAttendanceLoading, add: addToAttendanceRecord, update: updateAttendanceRecordDoc, remove: removeAttendanceRecordDoc } = useFirestoreCollection(
