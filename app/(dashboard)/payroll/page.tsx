...
export default function PayrollPage() {
  const { data: firestorePayroll, loading: firestorePayrollLoading, add: addToPayrollRecord, update: updatePayrollRecordDoc, remove: removePayrollRecordDoc } = useFirestoreCollection(
    COLLECTIONS.PAYROLL,
    [],
    []
  )
